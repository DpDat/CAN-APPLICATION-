#ifndef HYUNDAI_DECODE_H
#define HYUNDAI_DECODE_H
...
class Hyundai_decode : public QDialog
{
    Q_OBJECT

public:
    explicit Hyundai_decode(QWidget *parent = nullptr);
    ~Hyundai_decode();
