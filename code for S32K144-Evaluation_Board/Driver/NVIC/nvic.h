...
typedef struct {
  volatile uint32_t     ISER[8];         /** 0xE000E100 - 0xE000E11C **//**< Interrupt Set Enable Register n, array offset: 0x0, array step: 0x4 */
       uint8_t RESERVED_0[96];
  volatile uint32_t     ICER[8];         /** 0xE000E180 - 0xE000E19C **//**< Interrupt Clear Enable Register n, array offset: 0x80, array step: 0x4 */
       uint8_t RESERVED_1[96];
  volatile uint32_t     ISPR[8];         /** 0xE000E200 - 0xE000E21C **//**< Interrupt Set Pending Register n, array offset: 0x100, array step: 0x4 */
       uint8_t RESERVED_2[96];
  volatile uint32_t     ICPR[8];         /** 0xE000E280 - 0xE000E29C **//**< Interrupt Clear Pending Register n, array offset: 0x180, array step: 0x4 */
       uint8_t RESERVED_3[96];
  volatile uint32_t     IABR[8];         /** 0xE000E300 - 0xE000E31C0 **//**< Interrupt Active bit Register n, array offset: 0x200, array step: 0x4 */
       uint8_t RESERVED_4[224];
  volatile uint8_t  IPR[240];              /** 0xE000E400 - 0xE000E4EF **//**< Interrupt Priority Register n, array offset: 0x300, array step: 0x1 */
       uint8_t RESERVED_5[2576];
  volatile  uint32_t    STIR;                         /** 0xE000EF00 **//**< Software Trigger Interrupt Register, offset: 0xE00 */
} S32_NVIC_Type;
...
#define NVIC                                 ((S32_NVIC_Type *)S32_NVIC_BASE)
