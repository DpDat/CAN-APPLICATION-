#include "tesla_rtr.h"
#include "ui_tesla_rtr.h"
#include "tesla.h"
#include "mainwindow.h"

Tesla_rtr::Tesla_rtr(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::Tesla_rtr)
{
    ui->setupUi(this);
    ...
    connect(transmitTimer, &QTimer::timeout, this, &Tesla_rtr::sendCANFrame);
...
void Tesla_rtr::updateTable(const QList<CANMessageTransmit>& messages)
{
...
void Tesla_rtr::updateTableReceive(const QList<CANMessageReceive>& messages)
{
...
void Tesla_rtr::startBackgroundProcess(const QString &command)
{
...
void Tesla_rtr::on_buttonReturn_clicked()
{
    hide();
    Tesla *tl;
    tl = new Tesla(this);
...
void Tesla_rtr::on_btCANInterface_clicked()
{
...
void Tesla_rtr::on_BtnSetRequest_clicked()
{
...
void Tesla_rtr::on_pushButton_clicked(bool checked)
{
...
QList<CANMessageReceive> Tesla_rtr::filterCANMessages(const QList<CANMessageReceive>& messages) {
...
void Tesla_rtr::receiveCANFrame() {
    if (canDevice && canDevice->state() == QCanBusDevice::ConnectedState) {
...
void Tesla_rtr::Delay(int milliseconds) {
    QEventLoop loop;
    QTimer::singleShot(milliseconds, &loop, &QEventLoop::quit);
    loop.exec();
}

void Tesla_rtr::on_pushButton_2_clicked()
{
...
void Tesla_rtr::on_buttonSave_clicked()
{
...
void Tesla_rtr::on_buttonOpen_clicked()
{
...
void Tesla_rtr::on_buttonHome_clicked()
{
    hide();
    MainWindow *mw ;
