...
#include "ui_hyundai_monitor.h"
#include "hynndai.h"
#include "mainwindow.h"

Hyundai_monitor::Hyundai_monitor(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::Hyundai_monitor)
{
    ui->setupUi(this);
...
void Hyundai_monitor::updateTable(const QList<CANMessage>& messages)
{
...
void Hyundai_monitor::startBackgroundProcess(const QString &command)
{
...
void Hyundai_monitor::on_buttonHome_clicked()
{
    MainWindow *Mwd;
    hide();
...
void Hyundai_monitor::on_buttonReturn_clicked()
{
    Hynndai *hy;
    hide();
    hy = new Hynndai(this);
...
void Hyundai_monitor::on_btCANInterface_clicked()
{
...
void Hyundai_monitor::Delay(int milliseconds) {
    QEventLoop loop;
...
void Hyundai_monitor::on_btCANbps_clicked()
{
    ...
    if (canDevice->connectDevice()) {
        ...
        connect(canDevice, &QCanBusDevice::framesReceived, this, &Hyundai_monitor::handleReceivedMessage);
    } else {
...
void Hyundai_monitor::handleReceivedMessage()
{
    if (!canDevice) return;
...
void Hyundai_monitor::on_buttonStop_clicked()
{
...
void Hyundai_monitor::on_btCANFilter_clicked()
{
    bool ok;
...
void Hyundai_monitor::on_buttonSave_clicked()
{
...
void Hyundai_monitor::on_buttonOpenFile_clicked()
{
...
void Hyundai_monitor::startPulseview()
{
...
void Hyundai_monitor::on_pushButton_clicked()
{
    startPulseview();
}


Hyundai_monitor::~Hyundai_monitor()
{
    delete ui;
}
