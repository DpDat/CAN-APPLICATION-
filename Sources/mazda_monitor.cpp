...
Mazda_monitor::Mazda_monitor(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::Mazda_monitor)
...
Mazda_monitor::~Mazda_monitor()
{
    delete ui;
}


void Mazda_monitor::updateTable(const QList<CANMessage>& messages)
{
...
void Mazda_monitor::startBackgroundProcess(const QString &command)
{
...
void Mazda_monitor::on_buttonHome_clicked()
{
    hide();
...
void Mazda_monitor::on_buttonReturn_clicked()
{
    hide();
    mzd = new Mazda(this);
    mzd->show();
...
void Mazda_monitor::on_btCANInterface_clicked()
{
...
void Mazda_monitor::Delay(int milliseconds) {
    QEventLoop loop;
...
void Mazda_monitor::on_btCANbps_clicked()
{
    ...
    if (canDevice->connectDevice()) {
        ...
        connect(canDevice, &QCanBusDevice::framesReceived, this, &Mazda_monitor::handleReceivedMessage);
    } else {
...
void Mazda_monitor::handleReceivedMessage()
{
    if (!canDevice) return;
...
void Mazda_monitor::on_buttonStop_clicked()
{
...
void Mazda_monitor::on_btCANFilter_clicked()
{
    bool ok;
...
void Mazda_monitor::on_buttonSave_clicked()
{
...
void Mazda_monitor::on_buttonOpenFile_clicked()
{
