...
#include "ui_honda_monitor.h"
#include "honda1.h"
#include "mainwindow.h"

Honda_monitor::Honda_monitor(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::Honda_monitor)
{
    ui->setupUi(this);
...
Honda_monitor::~Honda_monitor()
{
    delete ui;
}

void Honda_monitor::updateTable(const QList<CANMessage>& messages)
{
...
void Honda_monitor::startBackgroundProcess(const QString &command)
{
...
void Honda_monitor::on_buttonHome_clicked()
{
    MainWindow *Mwd;
    hide();
...
void Honda_monitor::on_buttonReturn_clicked()
{
    Honda1 *hd1;
    MainWindow *Mwd;
    hide();
...
void Honda_monitor::on_btCANInterface_clicked()
{
...
void Honda_monitor::Delay(int milliseconds) {
    QEventLoop loop;
...
void Honda_monitor::on_btCANbps_clicked()
{
    ...
    if (canDevice->connectDevice()) {
        ...
        connect(canDevice, &QCanBusDevice::framesReceived, this, &Honda_monitor::handleReceivedMessage);
    } else {
...
void Honda_monitor::handleReceivedMessage()
{
    if (!canDevice) return;
...
void Honda_monitor::on_buttonStop_clicked()
{
...
void Honda_monitor::on_btCANFilter_clicked()
{
    bool ok;
...
void Honda_monitor::on_buttonSave_clicked()
{
...
void Honda_monitor::on_buttonOpenFile_clicked()
{
