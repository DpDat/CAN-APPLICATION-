...
Mazda_RTR::Mazda_RTR(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::Mazda_RTR)

{
    ...
    connect(transmitTimer, &QTimer::timeout, this, &Mazda_RTR::sendCANFrame);
...
void Mazda_RTR::updateTable(const QList<CANMessageTransmit>& messages)
{
...
void Mazda_RTR::updateTableReceive(const QList<CANMessageReceive>& messages)
{
...
void Mazda_RTR::startBackgroundProcess(const QString &command)
{
...
void Mazda_RTR::on_buttonReturn_clicked()
{
    hide();
    mazda = new Mazda(this);
    mazda->show();
}


void Mazda_RTR::on_btCANInterface_clicked()
{
...
void Mazda_RTR::on_BtnSetRequest_clicked()
{
...
void Mazda_RTR::on_pushButton_clicked(bool checked)
{
...
QList<CANMessageReceive> Mazda_RTR::filterCANMessages(const QList<CANMessageReceive>& messages) {
...
void Mazda_RTR::receiveCANFrame() {
    if (canDevice && canDevice->state() == QCanBusDevice::ConnectedState) {
...
void Mazda_RTR::Delay(int milliseconds) {
    QEventLoop loop;
    QTimer::singleShot(milliseconds, &loop, &QEventLoop::quit);
    loop.exec();
}

void Mazda_RTR::on_pushButton_2_clicked()
{
...
void Mazda_RTR::on_buttonSave_clicked()
{
...
void Mazda_RTR::on_buttonOpen_clicked()
{
...
void Mazda_RTR::on_buttonHome_clicked()
{
    hide();
    MainWindow *mw ;
